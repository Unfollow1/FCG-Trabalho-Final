...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view = Matrix_Camera_View(camera_position_new, camera_view_vector, camera_up_vector);
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mod)
{
    ...
    // esses ifs de wasd foram pegos das perguntas frequentes da cadeira
    if (key == GLFW_KEY_D)
    {
